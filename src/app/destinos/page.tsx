...
export default function DestinosPage() {
  ...
  const [promoDestinations] = useState<Destination[]>([
    ...
    { id: 'p3', name: 'Termas el Plomo', description: 'Inolvidable ruta de senderismo ecológico y acceso panorámico al imponente glaciar colgante.', image: '/images/MonumentoElMorado.jpg', price: 'Termas del Plomo: $55.000 – $70.000 | Transporte + entrada + picnic opcional' },
    { id: 'p4', name: 'Cascada de las Ánimas', description: 'Santuario pre-andino enfocado en el descanso premium, rodeado de caudalosos cruces de ríos.', image: '/images/CascadaAnimas.jpg', price: 'Cascada de las Ánimas: $40.000 – $55.000 CLP por persona (entrada + transporte + guía)' },
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-24 space-y-12">
            ...
            <div className="text-center mt-4 mb-10">
              <h2 className="font-serif text-2xl text-[#d4af37] italic font-light">
                Cajón del Maipo
              </h2>
            </div>
